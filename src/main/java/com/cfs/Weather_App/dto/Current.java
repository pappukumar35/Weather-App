...
public class Current {
	...
	public Current(int last_updated_epoch, String last_updated, double temp_c, double temp_f, int is_day,
			Condition condition, double wind_mph, double wind_kph, int wind_degree, String wind_dir, int pressure_mb,
			...
			double dewpoint_c, int dewpoint_f, int vis_km, int vis_miles, int uv, double gust_mph, double gust_kph,
			double short_rad, double diff_rad, double dni, int gti) {
		super();
		this.last_updated_epoch = last_updated_epoch;
		this.last_updated = last_updated;
		this.temp_c = temp_c;
